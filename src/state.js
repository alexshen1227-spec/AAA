...
function normalizeSave(raw) {
  ...
  return {
    ...
    items: {
      ...
      hushbell: finiteNumber(items.hushbell, 0, 0, 1, true),
      berry: finiteNumber(items.berry, 0, 0, 99, true),
      stormcap: finiteNumber(items.stormcap, 0, 0, 99, true),
      reedheart: finiteNumber(items.reedheart, 0, 0, 99, true),
    },
